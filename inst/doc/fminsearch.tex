\inputencoding{utf8}
\HeaderA{fminsearch}{Computation of the unconstrained minimimum of given function with the Nelder-Mead algorithm.}{fminsearch}
...
The \code{options} input argument is an optionnal list which can
...
\code{optimValues\$procedure} field represents the type of step preformed at
